...
def vels(target_linear_vel, target_angular_vel):
    return "currently:\tlinear x vel %s\t linear y vel %s " % (target_linear_vel,target_angular_vel)
...
if __name__=="__main__":
    ...
    status = 0
    #这里把linear看成了x速度，angular看成了y速度
    target_linear_vel   = 0.0  #目标速度
    target_angular_vel  = 0.0 
    control_linear_vel  = 0.0  #实际施加的速度速度
